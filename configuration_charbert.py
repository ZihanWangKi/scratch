...
class CharBertConfig(PretrainedConfig):
    ...
    def __init__(
        self,
        vocab_size=128, # 128 ascii, first with <pad> <bos> <eos> <bow> <eow> <unk> <mask>
        max_word_position_embeddings=128,
        max_char_position_embeddings=20,
        encoder_layers=6,
        ...
        num_labels=3,
        pad_token_id=0,
        bos_token_id=3, # actually start of word <bow>, for backward compatibility
        eos_token_id=4, # actually end of word <eow> for backward compatibility
        is_encoder_decoder=True,
        decoder_start_token_id=4, # same as eos_token_id
        forced_eos_token_id=4, # same as eos_token_id
        **kwargs
    ):
        super().__init__(
