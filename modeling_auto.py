...
from ..charbert.modeling_charbert import (
    CharBertForConditionalGeneration,
    CharBertForQuestionAnswering,
    CharBertForSequenceClassification,
    CharBertModel,
)
...
MODEL_WITH_LM_HEAD_MAPPING = OrderedDict(
    [
        ...
        (CharBertConfig, CharBertForConditionalGeneration),
...
MODEL_FOR_SEQUENCE_CLASSIFICATION_MAPPING = OrderedDict(
    [
        ...
        (CharBertConfig, CharBertForSequenceClassification),
